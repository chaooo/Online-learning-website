...
import top.chao.service.impl.CourseServiceImpl;
...
public class TestCourseController {
	...
	public void testLoadAll() throws Exception {
		String msg = ResultEnum.QUERY_SUCCESS.getMsg();
		//测试
		testHttp("get", "/course/all", null, msg);
	}
	
	@Test
	public void test1() {
		List<Course> list = courseDao.selectBySubjectId("new", 1);
		list.forEach(c->System.out.println(c.getId()+"  "+c.getName()+"/n"));
	}
	
	@Test
	public void test2() {
		List<Course> list = courseDao.selectByDirectionId("new", 1);
		list.forEach(c->System.out.println(c.getId()+"  "+c.getName()+"/n"));
	}
}
